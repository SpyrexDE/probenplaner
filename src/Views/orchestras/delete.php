<?php $this->layout('layouts/default', ['title' => 'Orchester löschen', 'currentPage' => $currentPage, 'isFluid' => true]) ?>
...
<div class="container-app py-8">
    <div class="max-w-lg mx-auto">
        <div class="card-base">
            ...
            <div class="p-6">
                <form action="/<?= ($_SESSION['current_org_slug'] ?? '') . '/' . ($_SESSION['current_orchestra_slug'] ?? '') ?>/orchestras/delete" method="post">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="/<?= ($_SESSION['current_org_slug'] ?? '') . '/' . ($_SESSION['current_orchestra_slug'] ?? '') ?>/orchestras/settings" class="btn-base btn-outline w-full text-center block">Abbrechen</a>
                    </div>
                </form>
            </div>
        </div>
