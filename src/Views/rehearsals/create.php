...
<div class="container-app mt-6">
    ...
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-700 text-center mb-8">Neuer Termin</h1>
            
            <form method="post" action="/rehearsals/create">
                <input type="date" id="date" name="date" value="<?= htmlspecialchars($formData['date'] ?? '') ?>" placeholder="Datum" class="form-input mb-5" required minlength="3" maxlength="50">
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                    <div>
                            <label for="start_time" class="block text-left mb-2 font-medium">Startzeit</label>
                        <input  type="time" id="start_time" name="start_time" value="<?= htmlspecialchars($formData['start_time'] ?? '') ?>" placeholder="Startzeit" class="form-input" required>
                        </div>
                    </div>
                    <div>
                            <label for="end_time" class="block text-left mb-2 font-medium">Endzeit</label>
                        <input  type="time" id="end_time" name="end_time" value="<?= htmlspecialchars($formData['end_time'] ?? '') ?>" placeholder="Endzeit" class="form-input" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-left">
                    ...
                    <div class="flex items-center mb-2 allCheck subCheck subCheckStr" class="indent-2"
                    ...
                    <!-- Blechbläser group -->
                    <div class="flex items-center mb-2 allCheck subCheck subCheckBl" class="indent-2"
                    ...
                    <div class="flex items-center mb-2 allCheck doubleSubCheck subCheckBl subCheckBBl" class="ml-18">
                    ...
                    <div class="flex items-center mb-2 allCheck doubleSubCheck subCheckBl subCheckHBl" class="ml-18">
