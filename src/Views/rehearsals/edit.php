...
<div class="container-fluid mt-4">
    ...
    <div class="float-none text-center">
        <div style="padding: 3px; margin: 0 auto; max-width: 600px;">
            <span class="float-none" style="color: #525861; font-size: 31px; font-family: Roboto, sans-serif; font-weight: 700; display: block; margin-bottom: 20px;">Termin bearbeiten</span>
