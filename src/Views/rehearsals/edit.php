        ...
        <h1 class="text-3xl font-bold text-gray-700 text-center mb-8">Termin bearbeiten</h1>
            ...
            <form method="post" action="/rehearsals/edit/<?= $rehearsal['id'] ?>">
                ...
                <div class="mb-10 text-left">
                    <button id="dropD" class="w-full btn btn-outline text-black dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button" style="background-color: <?= htmlspecialchars($formData['color'] ?? 'white') ?>;">Farbenauswahl</button>
