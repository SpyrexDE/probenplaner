...
class SmartGroupDisplayTest
{
    ...
    private function testBasicCases(): void
    {
        ...
        $this->runTest("Single tutti", ["tutti"], "Tutti");
    ...
    private function testComplexCombinations(): void
    {
        ...
        $this->runTest("Redundant", ["tutti", "Streicher"], "Tutti");
    }
    ...
    public function testPerformance(): void
    {
        ...
        $complexSelection = ["Violine_1", "Violine_2", "Bratsche", "Cello", "Kontrabass", 
                           "Flöte", "Oboe", "Klarinette", "Horn", "Trompete"];
